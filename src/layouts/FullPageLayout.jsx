  ...
  return (
    <div className="flex h-full w-full flex-col items-center text-white dark:bg-neutral-900">
      ...
      <div className="flex flex-initial items-center self-center">
        <Link to="mailto:light.studies@gmail.com" target="_blank" className="pr-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
            strokeWidth={1.5}
            className="h-8 w-8 dark:stroke-white dark:hover:bg-white dark:hover:stroke-black"
          >
            <path
              strokeLinecap="round"
        ...
        <Link to="https://www.instagram.com/flip_in_the_water/" target="_blank" className="pl-2">
          <svg
            ...
            height="24"
            viewBox="0 0 24 24"
            className="h-10 w-10 p-2 dark:fill-white dark:hover:bg-white dark:hover:fill-black dark:hover:stroke-black"
          >
