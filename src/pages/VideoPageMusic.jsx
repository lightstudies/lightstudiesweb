...
const VideoPageMusic = () => {
  const gridItems = [
    ...
    <ModalItem key="j1hjHpYiEJs" title="The Brilliance - Breathe" img={Breathe}>
      <ResponsivePlayer url="https://vimeo.com/819955070" parentClassName="pt16x9" playing controls />
    </ModalItem>,
    <ModalItem key="j1hjHpYiEJs" title="Up To The Mountain" img={UpMountain}>
      <ResponsivePlayer url="https://vimeo.com/819955922" parentClassName="pt16x9" playing controls />
    </ModalItem>,
    <ModalItem key="347398950" title="ATT Album Trailer" img={allThingsTogether}>
      <ResponsivePlayer url="https://player.vimeo.com/video/347398950" parentClassName="pt16x9" playing controls />
    </ModalItem>,
    <ModalItem key="350159161" title="BG Dance Project" img={BG} invertTitle>
