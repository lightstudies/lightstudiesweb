...
const VideoPageTheWhale = () => {
  return (
    <div className="flex h-auto flex-col gap-5 pt-5">
      <div className="px-4 pt-2 font-default-sans text-lg sm:text-2xl xl:px-0">
        <p>
          The Whale was our capstone short film which I shot on Super 16mm. It later would win the{' '}
          <Link
          ...
          , and we screened it in France at the{' '}
          <Link
            to="https://clermont-filmfest.org/en/"
            target="_blank"
            className="hover:bg-neutral-700 hover:text-white"
          >
